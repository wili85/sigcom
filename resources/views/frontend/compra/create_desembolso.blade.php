...
<div class="justify-content-center">
                                                    ...
                                                    <table id="tblCronograma" class="table table-hover table-sm">
                                                        <thead>
                                                            <tr style="font-size:13px">
																...
																<th class="text-left" width="10%">Fecha Pago</th>
                                                                <th class="text-right" width="10%">Cuota Pago</th>
																<th class="text-left" width="15%">Forma Pago</th>
																<th class="text-left" width="15%">Num Operaci&oacute;n</th>
																<!--<th width="5%"></th>-->
                                                            </tr>
                                                        </thead>
                                                        <tbody>
    ...
    @push('after-scripts')
    {!! script(asset('js/compraDesembolso.js')) !!}
