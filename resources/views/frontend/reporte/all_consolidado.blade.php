...
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
        <li class="breadcrumb-item text-primary">Inicio</li>
            <li class="breadcrumb-item active">Consolidado Estado Situacional</li>
        </li>
    </ol>
@endsection
        ...
        <div class="col col-sm-12 align-self-center">
            ...
            <div class="card">
                <div class="card-header">
                    <strong>
                        Lista de Consolidado del Estado Situacional
                    </strong>
                </div><!--card-header-->
                ...
                <div class="card-body">				
                    ...
                    <table id="tblAfiliado" class="table table-hover-grid table-sm">
                        ...
                        <tr style="font-size:13px">
                            ...
                            <th>Deuda Pendiente con Interes</th>
							<th>Deuda Total sin Interes</th>
							<th>Deuda Pendiente sin Interes</th>
                            <th>Monto Pagado</th>
							<th>Estado</th>
                        </tr>
                        </thead>
...
@push('after-scripts')
{!! script(asset('js/consolidadoLista.js')) !!}
@endpush
