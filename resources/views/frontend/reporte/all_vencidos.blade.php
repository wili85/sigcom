...
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
        <li class="breadcrumb-item text-primary">Inicio</li>
            <li class="breadcrumb-item active">Consulta de Prestamos Vencidos</li>
        </li>
    </ol>
@endsection
        ...
        <div class="col col-sm-12 align-self-center">
            ...
            <div class="card">
                <div class="card-header">
                    <div style="float:left"><strong>Lista de Prestamos Vencidos</strong></div>
					<div style="float:left;padding-left:20px;font-weight:bold">Total Valor Prestamo:</div>
					<div style="float:left;padding-left:6px" id="total_valor_prestamo"></div>
					<div style="float:left;padding-left:20px;font-weight:bold">Total Deuda Pendiente Con Interes:</div>
					<div style="float:left;padding-left:6px" id="total_deuda_pendiente_con_interes"></div>
					<div style="float:left;padding-left:20px;font-weight:bold">Total Deuda Pendiente Sin Interes:</div>
					<div style="float:left;padding-left:6px" id="total_deuda_pendiente_sin_interes"></div>
					<div style="float:left;padding-left:20px;font-weight:bold">Total Interes Pendiente:</div>
					<div style="float:left;padding-left:6px" id="total_interes_pendiente"></div>
				...
				<div class="row" style="padding:10px 20px 10px 20px;">
					...
					<div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
						<input class="btn btn-success pull-rigth" value="Excel" type="button" id="btnExcel" onclick="reporteVencidos()"/>
					</div>
                ...
                <div class="card-body">
                    ...
                    <table id="tblAfiliado" class="table table-hover-grid table-sm">
                        ...
                        <tr style="font-size:13px">
							...
							<!--<th>Deuda Total con Interes</th>-->
                            <th>Deuda Pend. con Interes</th>
							<!--<th>Deuda Total sin Interes</th>-->
							<th>Deuda Pend. sin Interes</th>
...
@push('after-scripts')
{!! script(asset('js/vencidosLista.js')) !!}
@endpush
