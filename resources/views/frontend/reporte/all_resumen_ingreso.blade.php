...
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
        <li class="breadcrumb-item text-primary">Inicio</li>
            <li class="breadcrumb-item active">Resumen de Ingreso Diario</li>
        </li>
    </ol>
@endsection
        ...
        <div class="col col-sm-12 align-self-center">
            ...
            <div class="card">
                <div class="card-header">
                    <strong>
                        Lista de Resumen de Ingreso Diario
                    </strong>
                </div><!--card-header-->
				...
				<div class="row" style="padding:10px 20px 10px 20px;">
					...
					<div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
						<input class="btn btn-success pull-rigth" value="Excel" type="button" id="btnExcel" onclick="reporteResumenIngreso()"/>
					</div>
...
@push('after-scripts')
{!! script(asset('js/resumenIngresoLista.js')) !!}
@endpush
