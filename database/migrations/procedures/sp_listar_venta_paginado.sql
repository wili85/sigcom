CREATE OR REPLACE FUNCTION public.sp_listar_venta_paginado(
...
Begin
	...
	v_campos=' t1.id,to_char(t1.fecha,''dd-mm-yyyy'')fecha,t1.destino
...
';
	...
	v_tabla='from ventas t1
inner join venta_detalles t2 on t1.id=t2.id_venta
