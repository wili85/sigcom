...
function cargarDesembolso(idSolicitud){
    ...
    $("#divDesembolso").html("");
	$.ajax({
			url: "/compra/obtener_desembolso/"+idSolicitud,
			type: "GET",
			success: function (result) {  
...
function cargarCronograma(idSolicitud){

    $("#tblCronograma tbody").html("");
	$.ajax({
			url: "/compra/obtener_cronograma/"+idSolicitud,
			type: "GET",
			success: function (result) {  
					//$('#id_solicitud').val(idSolicitud);
...
function datatablenew(){
    var oTable = $('#tblSolicitud').dataTable({
        "bServerSide": true,
        "sAjaxSource": "/compra/listar_compra_ajax",
        "bProcessing": true,
