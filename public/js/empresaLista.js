...
function cargarVehiculo(idSolicitud){

    $("#tblCronograma tbody").html("");
	$.ajax({
			url: "/empresa/obtener_vehiculo/"+idSolicitud,
			type: "GET",
			success: function (result) {  
...
function cargarChofer(idVehiculo){

    $("#tblChofer tbody").html("");
	$.ajax({
			url: "/empresa/obtener_chofer/"+idVehiculo,
			type: "GET",
			success: function (result) {  
					$("#tblChofer tbody").html(result);
			}
	});
            ...
            [	
                ...
                "mRender": function (data, type, row) {
					...
					if(row.estado!= null){
						...
						if(row.estado==2)estado = "INACTIVO";
					}
					return estado;
                },
                "bSortable": false,
