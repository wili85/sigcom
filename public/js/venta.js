...
function fn_save_venta(){
    
    //var fecha_atencion_original = $('#fecha_atencion').val();
	//var id_user = $('#id_user').val();
    $.ajax({
			url: "/venta/send_venta",
            type: "POST",
            //data : $("#frmCita").serialize()+"&id_medico="+id_medico+"&fecha_cita="+fecha_cita,
...
function AddFila(){
	...
	*/
	...
	$("#idEspecie"+ind).on("change", function (e) {
		...
		option = {
			url: '/venta/obtener_producto_medida/' + id_persona + '/' + id_persona + '/' + id_especie,
			type: 'GET',
			dataType: 'json',
			data: {}
		};
	...
	$("#idUnidad"+ind).on("change", function (e) {
		...
		*/
		option = {
			url: '/venta/obtener_precio_producto_medida/' + id_persona + '/' + id_persona + '/' + id_especie + '/' + id_unidad,
			type: 'GET',
			dataType: 'json',
			data: {}
		};
